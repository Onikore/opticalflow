...
Использование (после fetch_sat.py на машине с интернетом):
    ...
    python3 src/sat_test.py data/sat/esri_z19.json --cache data/bag_flight/bag2_cam_cache.npz
...
if __name__ == "__main__":
    ...
    ap.add_argument("--cache", default=str(DATA / "bag_flight" / "bag1_cam_cache.npz"))
    a = ap.parse_args()
    run(a.meta, a.cache)
